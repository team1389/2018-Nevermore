...
/**
 * assumed starting point is 1.0668 meters (3.5 ft) from left side, i.e. touching edge of
 * portal
 * 
 * @author Quunii
 *
 */
public class SameSideLeftSwitch extends AutoModeBase
{
	RobotSoftware robot;
	RobotCommands commands;

	public SameSideLeftSwitch(RobotSoftware robot)
	{
		this.robot = robot;
